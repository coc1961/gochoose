...
func NewTerminal() *Terminal {
	...
	t.keyboardFunc = t.makeKeyFunc(func(key keyboard.KeyEvent) {})
...
func (a *Terminal) Flush() *Terminal {
	_, _ = fmt.Fprint(os.Stderr, a.buf.String())
	a.buf.Reset()
	a.w.Reset()
	return a
}
...
func (a *Terminal) CursorPos() (int, int) {
	go func() {
		_, _ = io.WriteString(os.Stderr, "\x1b[6n")
	}()
	select {
